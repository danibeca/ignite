...
<body>
	...
	<h1><spring:message code="page.listOrganization.title" /></h1>
	<p><spring:message code="page.listOrganization.description" /></p>
	<table border="1px" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				<th width="10%"><spring:message code="label.id" /></th>
		...
		<tbody>
			<c:forEach var="organization" items="${organizations}">
				<tr>
					<td class="orgId">${organization.id}</td>
					<td class="orgName">${organization.name}</td>					
					<td>
